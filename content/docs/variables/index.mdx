...
Variables in Gapflow act as a global store for data that can be accessed and modified by any block in your workflow. They provide a powerful way to share information between different parts of your workflow, maintain state, and create more dynamic applications.
...
Variables in Gapflow can store various types of data:
...
Variables in Gapflow have global scope, meaning:
