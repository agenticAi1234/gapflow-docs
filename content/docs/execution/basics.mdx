...
description: Understanding the fundamental execution flow in Gapflow
---
...
When you run a workflow in Gapflow, the execution engine follows a systematic process to ensure blocks are executed in the correct order and data flows properly between them.
...
Run workflows on-demand through the Gapflow interface by clicking the "Run" button. This is perfect for:
