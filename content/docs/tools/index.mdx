...
Tools are powerful components in Gapflow that allow your workflows to interact with external services, process data, and perform specialized tasks. They extend the capabilities of your agents and workflows by providing access to various APIs and services.
...
There are two primary ways to use tools in your Gapflow workflows:
...
Gapflow provides a diverse collection of tools for various purposes, including:

- **AI and Language Processing**: [OpenAI](./openai), ElevenLabs, Translation services, [Mistral](./mistral)
...
- **Communication**: Slack, WhatsApp, Twilio SMS, Gmail, [GapTel SMS](./gaptel), [OmniDimension](./omnidimension) (voice campaigns & agents), [Bright Pattern](./bright-pattern) (contact-center lists & records), [Office 365 email](./office365-email)
- **CRM & sales**: [Salesforce](./salesforce), [HubSpot](./hubspot), [Dynamics 365](./dynamics365)
- **Microsoft 365 files**: [OneDrive](./onedrive)
- **Data Storage**: Pinecone, Supabase, Airtable
- **Data platforms**: [SQL Database](./sql-database)
- **Development**: GitHub
- **Glue & escape hatches**: [HTTP](./http), [Function](./function), [File](./file)
